...
$CFG->dbname    = '{{ hostvars['web_server']['app_db_name']}}';     // database name, eg moodle
$CFG->dbuser    = '{{ hostvars['web_server']['app_db_user']}}';   // your database username
$CFG->dbpass    = '{{ hostvars['web_server']['app_db_pass']}}';   // your database password
...
$CFG->wwwroot   = 'http://{{ hostvars['web_server']['ansible_host']}}';
